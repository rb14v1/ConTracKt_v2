...
import { Bell, Calendar, Clock, FileText, AlertTriangle, ExternalLink } from 'lucide-react';
...
export const Alerts = () => {
  ...
  // Filter for critical alerts (<= 20 days)
  const alerts = allAlerts.filter(a => a.days_remaining <= 20);
        ...
        <div className="flex-[2] bg-white border-r border-gray-200 p-8 overflow-y-auto">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-sm text-gray-500 mb-8 ml-12">
              Contracts expiring within 20 days requiring immediate attention.
            </p>
            ...
            {selected ? (
              <div className="animate-in fade-in duration-300">
                ...
                <div className="bg-gray-50 rounded-xl p-6 border border-gray-200">
                  <h3 className="text-sm font-bold text-gray-900 uppercase tracking-wide mb-3">Recommended Action</h3>
                  <p className="text-sm text-gray-600 leading-relaxed mb-6">
                    This contract is approaching its expiration date. Please review the terms for renewal or prepare termination notices immediately to avoid service disruption.
                  </p>

                  {/* Big Action Button (Optional secondary location) */}
          ...
          <div className="p-6">
            ...
            <div className="space-y-3">
              {alerts.map(alert => (
                ...
                >
                  <div className={clsx(
                    ...
                    alert.days_remaining <= 7 ? "bg-red-600" : "bg-red-400"
                  )} />
                  ...
                  <div className="pl-3">
                    <div className="flex justify-between items-start mb-1">
                      ...
                      <div className="flex items-center gap-2 ml-2">
                        ...
                        <span className="text-[10px] font-bold bg-red-50 text-red-600 px-2 py-0.5 rounded-full whitespace-nowrap">
              ...
              {alerts.length === 0 && !loading && (
                <div className="text-center py-10 text-gray-400 text-sm">No critical alerts.</div>
              )}
            </div>
          </div>
        </div>
